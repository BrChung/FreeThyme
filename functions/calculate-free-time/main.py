...
def find_free_time(busy_times):
    ...
    for doc_index in range(len(busy_times)):
        ...
        # If its in the middle calculations
            ...
            time_interval = {
                'start': busy_times[doc_index]['end'],
                'end': busy_times[doc_index + 1]['start']
            }
            freetime_list.append(time_interval)
